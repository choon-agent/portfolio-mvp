...
- 모델: **Sonnet 5** (Haiku 4.5 폴백) — 2026-09-14 Sonnet 4.6 에서 이행 (§4.2)
...
- **기본**: `claude-sonnet-5` (2026-09-14 이행. 4.6 대비 단가 $3/$15 → $2/$10, 토크나이저 ~30% 증가로 실질 ≈13% 절감. `temperature` 미전송 — Sonnet 5 는 sampling 파라미터 400 거부. `thinking: disabled` 명시 — 생략 시 adaptive 가 켜져 4.6 과 비용 프로파일이 달라짐)
...
Sonnet 5 가격 (2026-09 기준): 입력 $2/1M, 출력 $10/1M (Sonnet 4.6 시절: $3/$15 — 아래 산출은 4.6 기준 상한)
